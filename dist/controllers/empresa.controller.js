...
exports.existeEmpresa = existeEmpresa;
...
function createEmpresa(_x, _x2) {
  return _createEmpresa.apply(this, arguments);
}
function _createEmpresa() {
  _createEmpresa = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, empresa_id, cuit, telefono, email, newEmpresa;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, empresa_id = _req$body.empresa_id, cuit = _req$body.cuit, telefono = _req$body.telefono, email = _req$body.email;
          _context.prev = 1;
          _context.next = 4;
...
;
function getEmpresas(_x3, _x4) {
  return _getEmpresas.apply(this, arguments);
}
function _getEmpresas() {
  _getEmpresas = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var empresas;
...
function _updateEmpresa() {
  _updateEmpresa = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var empresa_id, _req$body2, nombre_id, latitud, longitud, comentarios, empresa;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          empresa_id = req.params.empresa_id;
          _req$body2 = req.body, nombre_id = _req$body2.nombre_id, latitud = _req$body2.latitud, longitud = _req$body2.longitud, comentarios = _req$body2.comentarios;
          _context6.next = 4;
          return _Empresa["default"].findAll({
...
;
function existeEmpresa(_x11, _x12) {
  return _existeEmpresa.apply(this, arguments);
}
function _existeEmpresa() {
  _existeEmpresa = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var empresa_id, empresa;
