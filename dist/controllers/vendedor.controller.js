...
function getVendedores(_x, _x2) {
  return _getVendedores.apply(this, arguments);
}
function _getVendedores() {
  _getVendedores = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var vendedores;
...
;
function getOneVendedor(_x3, _x4) {
  return _getOneVendedor.apply(this, arguments);
}
function _getOneVendedor() {
  _getOneVendedor = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var legajo_id, vendedor;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          legajo_id = req.params.legajo_id;
          _context2.next = 4;
